...
Содержит класс `MCLogger`, который инкапсулирует настройку корневого логгера
...
В модуле также определён глобальный экземпляр `mc_logger`, который можно
...
_ROOT_LOGGER_NAME = 'MC'

# ------------------------------------------

class MCLogger:
    """Класс для управления логгером пакета для работы с микроконтроллером.
    ...
    Пример использования:
        ...
        logger = app_logger.get_logger('MC.ComPort')
